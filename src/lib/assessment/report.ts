...
export function localReport(draft: AssessmentDraft, score: AssessmentScore) {
  ...
  const parts = [
    ...
    "",
    "3. ICF functioning snapshot (Plan Decoder scoring)",
    ...
    "ICF-style 0–4 qualifier used here: none (0–0.49), mild (0.5–1.49), moderate (1.5–2.49), severe (2.5–3.49), complete (3.5–4). Performance (real life) is scored. Capacity is recorded for comparison. This is not official ICF scoring.",
